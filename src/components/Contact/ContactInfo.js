        ...
        <div style={{ display: 'flex', gap: 48, flexWrap: 'wrap' }}>
          ...
          <div style={{ minWidth: 180, flex: 1 }}>
            ...
            <div style={{ display: 'flex', gap: 16 }}>
              <a   href="https://www.facebook.com/AppXes" 
  target="_blank"  style={{ display: 'inline-flex', alignItems: 'center', justifyContent: 'center', width: 32, height: 32, borderRadius: '50%', background: '#f3f4f6' }}><img src={fb} alt="fb" style={{ width: 40, height: 40 }} /></a>
